...
INSERT INTO [dbo].[Kick_Host] ([HostID], [HostName], [RootUrl], [SiteTitle], [SiteDescription], [TagLine], [LogoPath], [CreatedDateTime], [BlogUrl], [Email], [Skin], [Theme], [ShowAds], [Culture], [UICulture], [Publish_MinimumStoryAgeInHours], [Publish_MaximumStoryAgeInHours], [Publish_MaximumSimultaneousStoryPublishCount], [Publish_MinimumStoryScore], [Publish_MinimumStoryKickCount], [Publish_MinimumStoryCommentCount], [Publish_MinimumAverageStoryKicksPerHour], [Publish_MinimunAverageCommentsPerHour], [Publish_MinimumViewCount], [Publish_KickScore], [Publish_CommentScore], [AdsenseID], [TrackingHtml], [SmtpHost], [SmtpPort], [SmtpUsername], [SmtpPassword], [SmtpEnableSsl]) VALUES (1, N'localhost:8080', N'http://localhost:8080', N'localhost:8080', N'localhost:8080 is a testbed of a community based  news site edited by our members (we have only one).', N'Test news, with no real community', N'', '2007-07-06T00:00:00', N'http://blog.incremental.ie/', N'gavin@incremental.ie', N'Default', N'Default', 1, N'EN', N'EN', 0, 300, 8, 2, 0, 0, 0, 0, 0, 5, 2, N'pub-2786188635346157', N'', N'smtp.server.com', 25, N'auto@server.com', N'password', 0)
