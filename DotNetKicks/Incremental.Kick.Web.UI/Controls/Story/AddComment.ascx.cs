    ...
    public partial class AddComment : Incremental.Kick.Web.Controls.KickUserControl {
        ...
        protected void AddComment_Click(object sender, EventArgs e) {
            ...
            if (Comment.Text.Length < 4) {
                ...
                int commentID = CommentBR.CreateComment(this.KickPage.HostProfile.HostID, this._storyID, this.KickPage.KickUserProfile.UserID, this.KickPage.KickUserProfile, Comment.Text);
