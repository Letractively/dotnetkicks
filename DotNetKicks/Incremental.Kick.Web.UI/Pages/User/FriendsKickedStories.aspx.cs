    ...
    public partial class FriendsKickedStories : Incremental.Kick.Web.Controls.KickUserProfilePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.UserProfile.Friends.Count.Equals(0))
            {
                ...
                this.Paging.RecordCount = StoryCache.GetFriendsKickedStoriesPageCount(this.UrlParameters.UserIdentifier, this.HostProfile.HostID, this.UrlParameters.PageSize);
            }
