...
namespace Incremental.Kick.Dal
{
    ...
    /// </summary>
    [Serializable]
    public partial class UserFriend : ActiveRecord<User>
    {
        ...
        private static void GetTableSchema()
        {
            if (!IsSchemaInitialized)
            {
                ...
                colvarUserID.ColumnName = "FriendID";
                colvarUserID.DataType = DbType.Int32;
                colvarUserID.MaxLength = 0;
                colvarUserID.AutoIncrement = false;
                colvarUserID.IsNullable = false;
        ...
        /// </summary>
        public static void Insert(int hostId, int varUserId, int varFriendId, DateTime varCreatedOn)
        {
        ...
        /// </summary>
        public static void Update(int hostId, int varUserID, int varFriendID, DateTime varCreatedOn)
        {
            UserFriend item = new UserFriend();
