...
namespace Incremental.Kick.Dal
{
	...
	public partial class BannedUrlPattern : ActiveRecord<BannedUrlPattern>
	{
		...
		{
			get { return GetColumnValue<int>("PatternId"); }

			set { SetColumnValue("PatternId", value); }
		...
		{
			get { return GetColumnValue<string>("BannedUrlRegex"); }

			set { SetColumnValue("BannedUrlRegex", value); }
		...
		public Host Host
		{
			get { return Host.FetchByID(this.HostId); }
